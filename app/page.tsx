...
export default function Home() {
  return (
    <div>
      <nav className="h-24 bg-slate-100 flex justify-between">
        <div>
          <img
            src="logoTorden.png"
            alt="Logo de Torden"
      ...
      <div
        id="inicio"
        className=" flex justify-center w-full bg-gradient-to-b from-[#45ACAF] via-white to-[#45ACAF] px-[12%] "
      >
        <div>
      ...
      <div className="bg-[#EBFEFF] pt-10 flex justify-center px-[12%]">
        <div>
          <h2
            id="que_somos"
            className="text-5xl font-bold text-center text-[#03577B] "
          >
            ¿QUÉ SOMOS?
          </h2>
...
function BotonNavBar(props: Botonprops) {
  return (
    <a href={props.href}>
      <button className="p-4 rounded-2xl  hover:bg-[#03577B] hover:text-white shadow-xl mr-6 mt-3 text-xl text-black font-bold  transition-colors duration-500 ">
        {props.texto}
      </button>
    </a>
  );
